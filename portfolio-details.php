...
$page_title = 'Fardin - Portfolio Details';  // Set the page title

$banner_title = 'Portfolio Details'; // Set the banner title
$banner_subtitle = 'Know More Details About Project'; // Set the banner subtitle
?>
