		...
		<div class="container">
			...
			<div class="filters portfolio-filter">
				<ul>
					...
					<li data-filter=".admin">Admin Dashboard</li>
			...
			<div class="filters-content">
				<div class="row portfolio-grid justify-content-center">
					...
					<div class="col-lg-4 col-md-6 all popular ecommerce">
					...
					<div class="col-lg-4 col-md-6 all latest popular ecommerce">
						<div class="portfolio_box">
							<div class="single_portfolio">
					...
					<div class="col-lg-4 col-md-6 all business portfolio">
						<div class="portfolio_box">
							<div class="single_portfolio">
					...
					<div class="col-lg-4 col-md-6 all software latest">
						<div class="portfolio_box">
							<div class="single_portfolio">
					...
					<div class="col-lg-4 col-md-6 all admin popular">
						<div class="portfolio_box">
							<div class="single_portfolio">
